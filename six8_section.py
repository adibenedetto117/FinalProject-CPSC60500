...
class Ticker:
   def __init__(self, x, y, width, height, stocks_quantity):
...
def game_loop():
   global game_state, stocks_quantity
   ...
   stock_ticker = Ticker(screen.get_width() * 0.25 - 110, screen.get_height() // 2 - 50, 220, 100, stocks_quantity)
